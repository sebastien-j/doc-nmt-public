...
def main(job_id, params):
    ...
    validerr = train(saveto=params['model'][0],
                     ...
                     decoder='gru_cond_legacy_simple_sc',
                     valid_output='output/valid_output.4a',
                     other_output='output/other_output.4a')
    return validerr

if __name__ == '__main__':
    main(0, {
        'model': ['/misc/kcgscratch1/WIT3/en-fr/models/debug_model.4a.npz'],
        'dim_word': [250],
        'dim': [500],
        'n-words': [10234], 
        'optimizer': ['adadelta'],
